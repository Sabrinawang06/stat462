...
plot(alcohol1,p1, type='l', ylab='Probability',xlab='Alcohol Content', ylim=c(0,1),main="Probability of Quality vs. Alcohol Content")
...
plot(acidity,p1, type='l', ylab='Probability',xlab='Volatile Acidity', ylim=c(0,0.9),main="Probability of Quality vs. Volatile Acidity")
...
plot(sugar,p1, type='l', ylab='Probability',xlab='Residual Sugar', ylim=c(0,1),main="Probability of Quality vs. Residual Sugar Content")
...
plot(sulphate1,p1, type='l', ylab='Probability',xlab='Sulphates', ylim=c(0,1),main="Probability of Quality vs. Sulphates Content")
